...
var scheduler_production_min = createCommonjsModule(function(module, exports) {
  ...
  var L = [], M2 = [], N2 = 1, O2 = null, P3 = 3, Q = false, R2 = false, S2 = false;
  function T2(a) {
...
// build/dist/routes/Home.js
function Home() {
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement("p", {
    className: "text-2xl"
  }, "This calculator app is a web-based application built using the popular React framework for creating user interfaces, Snowpack for faster and more efficient development, and Tailwind for easy and customizable styling. This calculator app allows users to perform basic arithmetic operations, including addition, subtraction, multiplication, and division, as well as calculate percentages and clear the current value. The interface is designed to be user-friendly and responsive, allowing for easy input and output on a range of devices. With the power of React, the app ensures fast and seamless user experience, while Snowpack and Tailwind make development and styling a breeze."));
}
...
Button.propTypes = {
  ...
  buttonName: prop_types_default.string.isRequired
};
var Button_default = Button;

// build/dist/components/Result.js
function Result({
  className,
  display
}) {
...
Result.propTypes = {
  className: prop_types_default.string.isRequired,
  display: prop_types_default.string.isRequired
};
...
P2.cmp = function(y2) {
  var isneg, x = this, xc2 = x.c, yc2 = (y2 = new x.constructor(y2)).c, i = x.s, j = y2.s, k = x.e, l = y2.e;
  if (!xc2[0] || !yc2[0])
    return !xc2[0] ? !yc2[0] ? 0 : -j : i;
  if (i != j)
    return i;
  isneg = i < 0;
  if (k != l)
    return k > l ^ isneg ? 1 : -1;
  j = (k = xc2.length) < (l = yc2.length) ? k : l;
  for (i = -1; ++i < j; ) {
    if (xc2[i] != yc2[i])
      return xc2[i] > yc2[i] ^ isneg ? 1 : -1;
  }
...
P2.div = function(y2) {
  ...
  var bl, bt, n, cmp, ri2, bz = b.slice(), ai2 = bl = b.length, al = a.length, r = a.slice(0, bl), rl = r.length, q = y2, qc2 = q.c = [], qi2 = 0, p = dp + (q.e = x.e - y2.e) + 1;
  q.s = k;
  k = p < 0 ? 0 : p;
  bz.unshift(0);
  for (; rl++ < bl; )
...
P2.minus = P2.sub = function(y2) {
  var i, j, t, xlty, x = this, Big2 = x.constructor, a = x.s, b = (y2 = new Big2(y2)).s;
  if (a != b) {
    y2.s = -b;
    return x.plus(y2);
  }
  var xc2 = x.c.slice(), xe = x.e, yc2 = y2.c, ye = y2.e;
  if (!xc2[0] || !yc2[0]) {
    if (yc2[0]) {
      y2.s = -b;
    } else if (xc2[0]) {
  ...
  if ((b = (j = yc2.length) - (i = xc2.length)) > 0)
    for (; b--; )
      xc2[i++] = 0;
  for (b = i; j > a; ) {
    if (xc2[--j] < yc2[j]) {
...
P2.plus = P2.add = function(y2) {
  ...
  var xe = x.e, xc2 = x.c, ye = y2.e, yc2 = y2.c;
  if (!xc2[0] || !yc2[0]) {
    if (!yc2[0]) {
      if (xc2[0]) {
        y2 = new Big2(x);
  ...
  e = yc2.length;
  for (k = 0; e; xc2[e] %= 10)
    k = (xc2[--e] = xc2[e] + yc2[e] + k) / 10 | 0;
  if (k) {
    xc2.unshift(k);
    ++ye;
  }
  for (e = xc2.length; xc2[--e] === 0; )
    xc2.pop();
  y2.c = xc2;
  y2.e = ye;
  return y2;
...
P2.times = P2.mul = function(y2) {
  var c, x = this, Big2 = x.constructor, xc2 = x.c, yc2 = (y2 = new Big2(y2)).c, a = xc2.length, b = yc2.length, i = x.e, j = y2.e;
  y2.s = x.s == y2.s ? 1 : -1;
  if (!xc2[0] || !yc2[0]) {
    y2.c = [y2.e = 0];
    return y2;
...
P2[Symbol.for("nodejs.util.inspect.custom")] = P2.toJSON = P2.toString = function() {
...
var Big = _Big_();
var bigjs_default = Big;

// build/dist/logic/operate.js
function operate(numberOne, numberTwo, operation) {
  const one = bigjs_default(numberOne);
  const two = bigjs_default(numberTwo);
  if (operation === "+") {
...
// build/dist/routes/Calculator.js
function Calculator() {
  ...
  return /* @__PURE__ */ react.createElement("div", {
  ...
  }, /* @__PURE__ */ react.createElement(Result_default, {
    ...
    className: "reg-btn",
    buttonName: keys_default.ac,
    onClickAction: () => handleClick(keys_default.ac)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.pm,
    onClickAction: () => handleClick(keys_default.pm)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.perc,
    onClickAction: () => handleClick(keys_default.perc)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "act-btn",
    buttonName: keys_default.div,
    onClickAction: () => handleClick(keys_default.div)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.num7,
    onClickAction: () => handleClick(keys_default.num7)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.num8,
    onClickAction: () => handleClick(keys_default.num8)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.num9,
    onClickAction: () => handleClick(keys_default.num9)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "act-btn",
    buttonName: keys_default.mul,
    onClickAction: () => handleClick(keys_default.mul)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.num4,
    onClickAction: () => handleClick(keys_default.num4)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.num5,
    onClickAction: () => handleClick(keys_default.num5)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.num6,
    onClickAction: () => handleClick(keys_default.num6)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "act-btn",
    buttonName: keys_default.subs,
    onClickAction: () => handleClick(keys_default.subs)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.num1,
    onClickAction: () => handleClick(keys_default.num1)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.num2,
    onClickAction: () => handleClick(keys_default.num2)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.num3,
    onClickAction: () => handleClick(keys_default.num3)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "act-btn",
    buttonName: keys_default.sum,
    onClickAction: () => handleClick(keys_default.sum)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "wide-btn",
    buttonName: keys_default.num0,
    onClickAction: () => handleClick(keys_default.num0)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "reg-btn",
    buttonName: keys_default.dot,
    onClickAction: () => handleClick(keys_default.dot)
  }), /* @__PURE__ */ react.createElement(Button_default, {
    className: "act-btn",
    buttonName: keys_default.equal,
    onClickAction: () => handleClick(keys_default.equal)
  }));
}
...
// build/dist/components/Layout.js
function Layout() {
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Navbar_default, null), /* @__PURE__ */ react.createElement("div", {
    className: "layout"
  }, /* @__PURE__ */ react.createElement(Outlet, null)));
}
var Layout_default = Layout;

// build/dist/routes/Quote.js
function Quote() {
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement("h2", {
    className: "font-bold text-lg"
  }, '"Pure mathematics is, in its way, the poetry of logical ideas."'), /* @__PURE__ */ react.createElement("h3", {
    className: "mt-4"
  }, "Albert Einstein"));
}
...
function App() {
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Routes, null, /* @__PURE__ */ react.createElement(Route, {
    path: "/",
    element: /* @__PURE__ */ react.createElement(Layout_default, null)
